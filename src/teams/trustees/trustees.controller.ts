...
export class TrusteesController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves trustees data with pagination and filtering options. This endpoint is public and does not require authentication.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a specific trustee by their ID. This endpoint is public and does not require authentication.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new trustee with image upload. Requires admin authentication.',
  })
  @ApiBody({
  ...
  @ApiOperation({
    ...
    description:
      'Updates an existing trustee by ID with optional image upload. Requires admin authentication.',
  })
  @ApiParam({ name: 'id', description: 'Trustee ID' })
  @ApiBody({
  ...
  async updateTrustee(
    ...
    if (body.popupdesc !== undefined)
      updateTrusteeDto.popupdesc = body.popupdesc;
    if (body.link !== undefined) updateTrusteeDto.link = body.link;
    if (body.socialMedia !== undefined)
      updateTrusteeDto.socialMedia = body.socialMedia;
